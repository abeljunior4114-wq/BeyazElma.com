        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-xl border border-muted/30 bg-white/90 p-6 shadow-sm">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-4 py-3 sm:py-2.5 text-sm font-semibold text-white hover:bg-primary/90 transition touch-manipulation min-h-[44px] sm:min-h-0 w-full sm:w-auto"
            >
          ...
          <div className="rounded-xl border border-muted/30 bg-white/90 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-primary bg-primary/5 px-4 py-3 sm:py-2.5 text-sm font-semibold text-primary hover:bg-primary/10 transition touch-manipulation min-h-[44px] sm:min-h-0 w-full sm:w-auto"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={copyEmail}
                  className="rounded-lg border border-muted/60 px-4 py-3 sm:px-3 sm:py-2 text-xs font-medium hover:border-primary hover:text-primary transition touch-manipulation min-w-[60px] min-h-[44px] sm:min-w-0 sm:min-h-0 flex items-center justify-center"
